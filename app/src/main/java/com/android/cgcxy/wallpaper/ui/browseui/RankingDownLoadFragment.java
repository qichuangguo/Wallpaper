 ...
 */
public class RankingDownLoadFragment extends BaseFragment implements ShowView{
    ...
    public static RankingDownLoadFragment newInstance() {

        Bundle args = new Bundle();

        RankingDownLoadFragment fragment = new RankingDownLoadFragment();
    ...
    public int getLayoutId() {
        return R.layout.fragment_ranking_down_load;
    }
